...
# Autogenerated by pycargoebuild 0.13
# Derived from main gentoo ebuild
...
src_compile() {
	...
	mkdir man || die
	for i in $(ls *scd); do
    # Did not found a way to handle scd files with gentoo eclasses/functions
		scdoc <${i} >man/$(basename -s .scd ${i}) || die
	done
...
src_install() {
	...
	for i in $(ls extra/man/man); do
		doman "extra/man/man/${i}"
	done

	doinfo extra/alacritty.info
